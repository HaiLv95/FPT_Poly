...
<div class="container">
    <div class="col-md-12">
        <div class="col-md-6 offset-md-3">
            ...
            <c:url var="url" value="/Edit-profile"/>
            <!-- Form -->
            <form action="${url}" method="post" class="form-group">
                <label class="form-label">Username</label> <input
                    ...
                    name="id" placeholder="UserID"> <br> <label
                    class="form-label">Fullname</label> <input class="form-control"
                                                               name="fullname" value="${user.fullname}"> <br> <label
                    class="form-label">Email</label> <input class="form-control"
                                                            name="email" type="email" value="${user.email}"> <br>
                <br> <label class="form-label">Password</label> <input
                    class="form-control" name="password" type="password"
                    value="${user.password}"> <br> <br>
                <hr>
                <button class="btn btn-success"
                        style="margin-left: 15rem; width: 10rem">Cập nhật
                </button>
            </form>
        </div>
    </div>
